...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s brynercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  brynercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded brynercoin transaction") + "\n" +
              "  brynercoin-tx [options] -create [commands]   " + _("Create hex-encoded brynercoin transaction") + "\n" +
              "\n";
