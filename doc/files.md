...
* brynercoin.conf: contains configuration settings for brynercoind or brynercoin-qt
* brynercoind.pid: stores the process id of brynercoind while running
...
* debug.log: contains debug information and general logging generated by brynercoind or brynercoin-qt
