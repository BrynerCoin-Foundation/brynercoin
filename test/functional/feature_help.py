...
"""Verify that starting brynercoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start brynercoin with -h for help text")
        ...
        self.log.info("Start brynercoin with -version for version information")
